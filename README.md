...
```
cd existing_repo
git remote add origin https://gitlab.com/survivalnightgame/teamup-notify.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/survivalnightgame/teamup-notify/-/settings/integrations)
